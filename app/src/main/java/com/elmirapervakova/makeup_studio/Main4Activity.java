...
import static com.elmirapervakova.makeup_studio.DBHelper.TABLE_CONTACTS;

public class Main4Activity extends AppCompatActivity implements
        View.OnClickListener {

    private Button btnDatePicker;
    private Button EnterN;
    private EditText editTextDate,stTel,stName,stArtist,stTime,stData;
    private Spinner spinner,spinner1;

    int etD,etTl,etN;

    private String[] Artist = {"Алия","Анна"};
    private String[] Time = {"09:00","11:30","14:00","17:30","20:00"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EnterN = (Button) findViewById(R.id.EnterN);
